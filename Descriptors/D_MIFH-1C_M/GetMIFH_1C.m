function [MIFH] = GetMIFH_1C(img,bh,bs,bv,Nv,subS,dx,dy)
...
Q_image=GetQuantHSV(Chsv,r3,c3,bh,bs,bv);%Chsv
...
H1=Co_hist(M1,Nv,dx,dy);H2=Co_hist(M2,Nv,dx,dy);H3=Co_hist(M3,Nv,dx,dy);
