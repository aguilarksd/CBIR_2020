...
% // Valores del kernel
v1=(A/((1-A)^2))*(2/sqrt(8))*exp(-(A/(1-A))*sqrt(8));
v2=(A/((1-A)^2))*(2/sqrt(5))*exp(-(A/(1-A))*sqrt(5));
v3=(A/((1-A)^2))*exp(-(2*A/(1-A)));
v4=(A/((1-A)^2))*(1/sqrt(5))*exp(-(A/(1-A))*sqrt(5));
v5=(A/((1-A)^2))*exp(-(A/(1-A)));
% // Kernels
Sx=[v1 v4  0 -v4 -v1;
    v2 v5  0 -v5 -v2;
    v3 v5  0 -v5 -v3;
